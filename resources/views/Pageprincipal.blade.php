...
<body class="antialiased">
    ...
    <table class="table" style="border-collapse:collapse; table-layout:fixed; width:100%;">
        ...
        <tbody>
            ...
            <a href="{{ url('/ajouter') }}"><button type="button" class="btn btn-success" style="margin-bottom : 50px;margin-left : 10px">Ajouter</button></a>
            ...
            <tr>
                ...
                <td style="background : #A52A2A;color : white">{{$objectLignePersonnage->getDetail()}}</td>
                <td style="background : #A52A2A;color : white">{{$objectLignePersonnage->getProprietaire()}}</td>
                <th scope="col"><a href="/modifier/{{$objectLignePersonnage->getId()}}" style="color:#FE9A01;">
                        <p>Modifier</p>
                    </a> <a href="supprimer/{{$objectLignePersonnage->getId()}}" style="color:#FE0101;">
                        <p>suppr</p>
                    </a></th>
            </tr>
            ...
            <tr>
                ...
                <td style="background : #2BA6A6;color : white">{{$objectLignePersonnage->getDetail()}}</td>
                <td style="background : #2BA6A6;color : white">{{$objectLignePersonnage->getProprietaire()}}</td>
                <th scope="col"><a href="/modifier/{{$objectLignePersonnage->getId()}}" style="color:#FE9A01;">
                        <p>Modifier</p>
                    </a> <a href="supprimer/{{$objectLignePersonnage->getId()}}" style="color:#FE0101;">
                        <p>suppr</p>
            ...
            @elseif ( $objectLignePersonnage->getClasse() === "Prêtre")

            <tr>
                <td class="pseudo">{{$objectLignePersonnage->getPseudo()}}</td>
                <td>{{$objectLignePersonnage->getRace()}}</td>
                <td>{{$objectLignePersonnage->getPointDeVie()}}</td>
                <td>{{$objectLignePersonnage->getArmure()}}</td>
                <td>{{$objectLignePersonnage->getDetail()}}</td>
                <td>{{$objectLignePersonnage->getProprietaire()}}</td>
                <th scope="col"><a href="/modifier/{{$objectLignePersonnage->getId()}}" style="color:#FE9A01;">
                        <p>Modifier</p>
                    </a> <a href="supprimer/{{$objectLignePersonnage->getId()}}" style="color:#FE0101;">
                        <p>suppr</p>
            ...
            <tr>
                ...
                <td style="background : #32CD32;color : white">{{$objectLignePersonnage->getDetail()}}</td>
                <td style="background : #32CD32;color : white">{{$objectLignePersonnage->getProprietaire()}}</td>
                <th scope="col"><a href="/modifier/{{$objectLignePersonnage->getId()}}" style="color:#FE9A01;">
                        <p>Modifier</p>
                    </a> <a href="supprimer/{{$objectLignePersonnage->getId()}}" style="color:#FE0101;">
                        <p>suppr</p>
            ...
            <script>
                function changerCouleurText(text) {
                    ...
                    for (let index = 0; index < tableautext.length; index++) {

                        let randomColor = (Math.floor(Math.random() * 0xFFFFFF)).toString(16);

                        textcouleur += "<strong><span font-weight: bold; style='color : red; color : #" + randomColor + "' >" + tableautext[index] + "</span></strong>";
                ...
                for (let index = 0; index < pseudo.length; index++) {
                    ...
                    pseudo[index].innerHTML = changerCouleurText(pseudo[index].innerHTML);
